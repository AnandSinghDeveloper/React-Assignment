              ...
              <input 
               ...
               id="fileInput" 
                onChange={handleFileChange} className=' hidden'  />
                  {image && <img src={image} alt="Profile" style={{ position:'relative', width: 120, borderRadius: "50%", height: 120, objectFit: "cover" }} />} 
                 ...
                 <div className='mt-5'>
                 <h1 className='  text-center text-2xl font-medium'>John Doe</h1>
                 <h2 className=' text-center text-base font-medium'>john@gmail.com</h2>
                 </div>
